...
func postgresIndexType(indexType database.IndexType) string {
	switch indexType {
...
func parsePostgresIndexType(pgType string) database.IndexType {
...
func formatCreatePropertyConstraint(constraintName, tableName, fieldName string, indexType database.IndexType) string {
...
func formatCreatePropertyIndex(indexName, tableName, fieldName string, indexType database.IndexType) string {
	var (
		pgIndexType  = postgresIndexType(indexType)
	...
	if indexType == database.IndexTypeTextSearch {
